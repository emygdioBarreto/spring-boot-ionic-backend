package br.com.its.cursomc.resources.exception;
...
import br.com.its.cursomc.manager.exception.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> Authorization(AuthorizationException e, HttpServletRequest request) {
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.FORBIDDEN.value(), "Not found", e.getMessage(), request.getRequestURI());
